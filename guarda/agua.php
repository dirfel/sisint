...
foreach($linhas as $linha) {
    $dados[] = array(
        'data' => $linha['data'],
        'consumo' => $linha['agua_int_atual']/10 - $linha['agua_int_anterior']/10,
        'consumo1' => $linha['agua_ext_atual']/100 - $linha['agua_ext_anterior']/100
    );
}

// Calcula o consumo total
$consumo_total = ($linhas[count($linhas) - 1]['agua_int_atual'] - $linhas[0]['agua_int_anterior'])/10;
$consumo_total1 = ($linhas[count($linhas) - 1]['agua_ext_atual'] - $linhas[0]['agua_ext_anterior'])/100;

// Cria a tabela com o consumo diário
?>
<table>
<tr>
    <td colspan="2" align="center"><h2>CONSUMO DE ENERGIA ÁGUA NO MÊS <?=$mes . '/' . $ano ?>,<br>CONFORME LIVROS DO OFICIAL-DE-DIA - <?=ABR_OM?></h2></td>
</tr>
<tr><th>
<table border="1" >
    <thead>
        <tr>
            <th>Data</th>
            <th>Consumo Interno (m³)</th>
            <th>Consumo Externo (m³)</th>
        </tr>
    </thead>
    <tbody>
        <?php foreach ($dados as $linha) { ?>
            <tr>
                ...
                <td align="center"><?= number_format((float)$linha['consumo'], 2, ',', '') ?></td>
                <td align="center"><?= number_format((float)$linha['consumo1'], 2, ',', '') ?></td>
            </tr>
        <?php } ?>
        <tr>
            <th align="center">Total</th>
            <th align="center"><?= number_format((float)$consumo_total, 2, ',', '') ?></th>
            <th align="center"><?= number_format((float)$consumo_total1, 2, ',', '') ?></th>
        </tr>
    </tbody>
</table></th>
<?php
...
<!-- <div style=""> -->
    ...
    <hr>
    <canvas id="grafico1" width="500px"></canvas>
    <script>
