...
<body>
  <div class="wrap">
    ...
    <div class="page-body">
      ...
      <div class="content">
      <?php render_content_header('Lançamentos de Entrada e Saída de Veículos', 'fa fa-cutlery'); ?>
        <div class="row animated fadeInUp">
          <?php include '../recursos/views/token.php'; ?>
          <div class="col-sm-12 col-md-12">
            <div class="panel"><?php render_cabecalho_painel('RELAÇÃO DE VEÍCULOS DENTRO DO QUARTEL EM '.$data, 'fa fa-car', true); ?>
                ...
                <table id="responsive-table" class="tabela table table-striped table-hover responsive nowrap" width="100%">
                  ...
                  <tbody>
                    ...
                    $consulta_rel_visitantes = $pdo1->prepare("SELECT visitante.id, visitante.nomecompleto, visitante.tipo, visitante.idveiculo, visitante.cracha, visitante.celular, visitante.identidade, veiculo.placa, 
                      ...
                      WHERE visitante.situacao = '1' AND visitante.idveiculo != 0");
